...
public class EventFragment extends Fragment {
    ...
    private ArrayList<EventQ> mDataset;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        eventRecycler = (RecyclerView) view.findViewById(R.id.event_recycler);

        mDataset = new ArrayList<EventQ>();
    ...
    private void buildRecycler() {
        ...
        mAdapter = new EventAdapter(this.getContext(),mDataset);
    ...
    private void chacthData(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot ds: dataSnapshot.child("Events").getChildren()){
            ...
            String lokasi = ds.child("lokasi").getValue().toString();
                String tanggal = ds.child("tanggal").getValue().toString();
                String imgName = ds.child("imageName").getValue().toString();

            temp = new EventQ(nama,lokasi,tanggal, imgName);
            mDataset.add(temp);
